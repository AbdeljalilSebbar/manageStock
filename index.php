...
<body>
	...
	<div class="drawer" id="drawer">
		...
		<form method="POST">
			...
			<div class="form-group">
				...
				<input type="text" name="cat" id="form_cat" list="category_options" placeholder="Choisir ou écrire...">
			...
			<div style="display: flex; gap: 10px;">
				...
				<div class="form-group" style="flex:1;">
					<label>Unité</label>
					<input type="text" name="unit" id="form_unit" list="unit_options" placeholder="Unité...">
			...
			<div class="form-group">
				...
				<input type="date" name="buyDate" id="form_buy">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label>Notes</label>
				<textarea name="notes" id="form_notes" rows="3"></textarea>
			</div>
					...
					<tbody>
						<?php foreach ($products as $p): ?>
							<tr>
								...
								<td style="color: var(--gray); font-size: 0.85rem;"><?php echo $p['buyDate']; ?></td>
								<td style="color: var(--danger); font-size: 0.85rem; font-weight: 500;"><?php echo $p['exp']; ?></td>
	...
	<script>
		...
		function openUse(product) {
			...
			document.getElementById('use_form_unit').innerText = product.unit;
